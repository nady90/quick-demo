...
export default function CodeContainer() {
  return (
    <div className="max-w-120 shadow-lg bg-white max-h-47.5 pb-2 px-2 rounded-3xl flex flex-col border-8 border-gray-50">
      ...
      >
        <div className="w-full pointeven h-full bg-linear-180 left-0 top-0 mask-t-from-0% from-[#101829]/10 to-[#282F55] absolute"></div>
        {JSON.stringify(
          {
